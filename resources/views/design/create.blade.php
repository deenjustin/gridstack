...
@section('page','Create Content')
@section('content')
@include('layout.tiny')
<script src="{{ url('') }}/assets/scripts/jquery.min.js"></script>
<form  method="POST" action="{{ url('content') }}" class="row col-12">
    @csrf
<div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" name="name" id="cname"/>
                </div>
            </div>
            <div class="col-md-12">
                <div id="code">
            ...
            <textarea style="display: none;" id="codefinel" name="content"></textarea>
