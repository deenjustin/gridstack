...
<div class="row ">
    ...
    <form method="POST" action="{{ url('') }}/layout/{{encrypt( $layout->id )}}" class="col-12 row">
        @csrf
        @method('PUT')
    <div class="col-md-2 pl-4 d-none d-md-block side">
        ...
        <div class="row">
          <div class="col-12">
            Do You Want Update? <input type="checkbox" id="isAgree" />
          </div>
      ...
      <div class="col-12 border border-right-0  border-bottom-0 border-left-0 pt-4 pb-4">
